function [tv,N_open, iKr, v, M] = Markov_teste(N)

% N -> Numero de canais
% colocar as outras variaveis como entradas
% [tv,N_open, iKr, v, M] = Markov_teste(N, var2, var3, ....)
% removar o valor de entrada manual
